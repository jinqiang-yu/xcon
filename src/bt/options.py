...
class Options(object):
    ...
    def parse(self, command):
        ...
        try:
            opts, args = getopt.getopt(command[1:],
                                    'a:A:b:cd:e:f:hi:I:k:L:lm:Mn:N:o:pr:qs:tu:vVwx:',
                                    ['accmin=',
                                     'approach=',
                                     'batch=',
                                     'encode=',
    ...
    def usage(self):
        ...
        print('                                   Available values: use, none (default = <none>)')
        ...
        print('        -i, --info=<string>        Path to data information (default: <none>)')
        print('        -I, --nof-inst             The number of instances being computed (default: None)')
