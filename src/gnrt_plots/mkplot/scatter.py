...
class Scatter(Plot, object):
    ...
    def create(self, data):
        ...
        if self.x_log or self.y_log:
            ...
            plt.plot(x, x - step * 3, 'g:', lw=1.5, zorder=3)
            plt.plot(x, x + step * 3, 'g:', lw=1.5, zorder=3)
            plt.fill_between(x, x - step * 3, x + step * 3, facecolor='green', alpha=0.15, zorder=3)
        ...
        if (not self.x_log) or (not self.y_log):
